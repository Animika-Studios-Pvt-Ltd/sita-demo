      ...
      <div className="mt-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              ...
              <p className="text-slate-600 text-sm md:text-base mt-1">
                Create, edit, and publish long-form articles.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-6 grid grid-cols-1 lg:grid-cols-2 gap-4">
          <div className={glassCard}>
            <h3 className="text-lg font-semibold text-[#7A1F2B] mb-2">No articles yet</h3>
            <p className="text-sm text-slate-600">
              Start writing your first article to populate this section.
            </p>
          </div>
          <div className={glassCard}>
            <h3 className="text-lg font-semibold text-[#7A1F2B] mb-2">Publishing workflow</h3>
            <p className="text-sm text-slate-600">
              Drafts, scheduled posts, and published articles will show here.
            </p>
          </div>
        </div>
      </div>
