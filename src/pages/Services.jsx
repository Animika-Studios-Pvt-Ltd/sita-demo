...
import corporateWellness from "../assets/corporate-&-group-wellness.jpg";
  ...
  return (
    <div>
      ...
      <section className="bg-[#F5EBE8] py-24 text-center">
        <Reveal>
          ...
          <p className="max-w-3xl mx-auto text-gray-700 leading-relaxed">
            ...
            Ayurveda, and Kosha Counseling to support healing, resilience, and
        ...
        <div className="grid md:grid-cols-3 gap-12">
          ...
          <Reveal delay={0.1}>
            <div
              ...
              <div className="p-8 flex flex-col flex-1">
                <h3 className="mb-4 text-[#A67365]">1:1 Private Sessions</h3>
                <p className="text-gray-600 leading-relaxed mb-6">
                  ...
                  address physical discomfort, emotional stress, and inner
                  balance.
                </p>
          ...
          <Reveal delay={0.2}>
            <div
              ...
              <div className="p-8 flex flex-col flex-1">
                <h3 className="mb-4 text-[#A67365]">Healing Programs</h3>
                <p className="text-gray-600 leading-relaxed mb-6">
                  Structured multi-week programs designed for deeper
                  transformation, combining movement, breath, nourishment,
      ...
      <section className="py-24 p-4 bg-gray-50 text-center">
        <Reveal>
          <h2 className="mb-4 p-4 text-[#A67365]">Unsure where to begin?</h2>
          <p className="mb-8 text-gray-700 max-w-2xl mx-auto leading-relaxed">
            Begin with a complimentary consultation to explore your needs and
            discover the most supportive path forward.
          </p>
          <Link
            to="/book-meeting"
