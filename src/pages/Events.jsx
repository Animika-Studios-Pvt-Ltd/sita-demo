      ...
      <section className="bg-[#F5EBE8] py-24 text-center">
        <Reveal>
          ...
          <p className="max-w-3xl mx-auto text-gray-700 leading-relaxed">
            Curated experiences that create space for reflection,
            learning, and collective healing — online and in person.
          </p>
        </Reveal>
      </section>
          ...
          <Reveal delay={0.1}>
            <div className="bg-white rounded-2xl overflow-hidden shadow-md
              ...
              <div className="p-4">
                ...
                <span className="text-sm text-gray-500 p-6">Upcoming • Limited spaces</span>
              </div>
            </div>
          </Reveal>
          ...
          <Reveal delay={0.2}>
            <div className="bg-white rounded-2xl overflow-hidden shadow-md
              ...
              <div className="p-4">
                ...
                <p className="text-gray-600 leading-relaxed mb-4 p-6">
                  Monthly online gatherings exploring mindfulness,
                  kosha awareness, and shared reflection in a safe space.
                </p>
                <span className="text-sm text-gray-500 p-6">Monthly • Online</span>
              </div>
            </div>
          </Reveal>
