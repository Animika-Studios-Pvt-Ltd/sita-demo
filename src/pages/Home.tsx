...
import sitaBanner from "../assets/banner-sita.jpg";
import sitaImage from "../assets/sita-image.jpg";
import yogaPrograms from "../assets/sita-yoga-therapy.jpg";
import ayurvedicYoga from "../assets/sita-ayurveda.jpeg";
import koshaCounseling from "../assets/sita-kosha-counseling.jpeg";
  ...
  return (
    <div>
        ...
        <div className="relative z-20 text-center max-w-4xl mx-auto px-4">
          ...
          <Reveal delay={0.15}>
            <p className="mb-8 opacity-90 max-w-2xl mx-auto">
              Experience the power of integrated Yoga Therapy, Ayurveda, and
              Kosha Counseling to achieve balance, healing, and authentic
              well-being.
            </p>
          </Reveal>
          ...
          <Reveal>
            <div>
              ...
              <p className="text-gray-700 mb-4">
                With over 15 years of experience in holistic wellness, Sita
                brings together ancient wisdom and modern therapeutic practices
                to guide you on your healing journey.
              </p>
              <p className="text-gray-700 mb-6">
                Her unique approach integrates Yoga Therapy, Ayurvedic
                principles, and Kosha Counseling to address the whole
          ...
          <Reveal>
            <div className="text-center mb-12">
              ...
              <p className="text-gray-700 max-w-2xl mx-auto">
                A comprehensive approach to wellness that integrates three
                powerful modalities to support your complete transformation.
              </p>
            </div>
          </Reveal>
              ...
              <div
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600 mb-4">
                    Evidence-based therapeutic yoga tailored to your unique
                    needs.
                  </p>
                  <Link
                    to="/yoga-therapy"
            ...
            <Reveal delay={0.2}>
              <div
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600 mb-4">
                    Personalized nutrition and lifestyle guidance rooted in
                    Ayurveda.
                  </p>
                  <Link
                    to="/ayurveda"
            ...
            <Reveal delay={0.3}>
              <div
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600 mb-4">
                    Explore the five layers of being to unlock your full
                    potential.
                  </p>
                  <Link
                    to="/kosha-counseling"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Reveal>
            <div className="text-center mb-12">
              ...
              <p className="text-gray-700 max-w-2xl mx-auto">
                Personalized offerings designed to support healing, growth, and
                transformation.
              </p>
            </div>
          </Reveal>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Reveal delay={0.1}>
              <div className="bg-gray-50 rounded-xl p-8 hover:shadow-lg transition-all">
                ...
                <p className="text-gray-600 mb-4">
                  Private Yoga, Ayurveda, or Kosha guidance sessions tailored to
                  individual healing goals.
                </p>
              </div>
            </Reveal>
            ...
            <Reveal delay={0.2}>
              <div className="bg-gray-50 rounded-xl p-8 hover:shadow-lg transition-all">
                ...
                <p className="text-gray-600 mb-4">
                  Guided healing programs designed to support steady growth and
            ...
            <Reveal delay={0.3}>
              <div className="bg-gray-50 rounded-xl p-8 hover:shadow-lg transition-all">
                <h3 className="mb-3 text-[#A67365]">
                  Corporate & Group Wellness
                </h3>
                <p className="text-gray-600 mb-4">
                  Wellness programs and workshops created to enhance balance,
                  clarity, and well-being in groups.
                </p>
              </div>
            </Reveal>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Reveal delay={0.1}>
              <div className="bg-white rounded-xl p-6 shadow-md hover:-translate-y-1 transition-all">
                <h3 className="text-[#A67365] mb-2">
                  Seasonal Wellness Retreat
                </h3>
                <p className="text-gray-600 mb-3">
                  A multi-day immersive retreat focused on rest, nourishment,
                  and renewal.
                </p>
            ...
            <Reveal delay={0.2}>
              <div className="bg-white rounded-xl p-6 shadow-md hover:-translate-y-1 transition-all">
                ...
                <p className="text-gray-600 mb-3">
                  Guided group sessions exploring the koshas and mindful
                  practices.
                </p>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <Reveal>
          <div
            className="bg-gradient-to-r from-[#A67365] to-[#8B5E4F]
                          rounded-2xl p-12 text-center text-white">
            <h2 className="mb-4 text-white">Ready to Begin Your Journey?</h2>
            <p className="mb-8 opacity-90 max-w-2xl mx-auto">
              Schedule a complimentary consultation to discuss your wellness
              goals.
            </p>
            <Link
              to="/book-meeting"
