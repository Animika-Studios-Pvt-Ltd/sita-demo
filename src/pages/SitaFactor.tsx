...
import sitaFactor from "../assets/sita-factor-banner.jpg";
      ...
      <section className="relative h-[400px] flex items-center justify-center text-white">
        ...
        <div className="relative z-20 text-center max-w-4xl mx-auto px-4">
          ...
          <p className="text-white opacity-90">
            A holistic approach to wellness that integrates body, mind, and
            spirit
          </p>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-gray-700 mb-4">
            The Sita Factor is a comprehensive wellness methodology that brings
            together three powerful healing modalities: Yoga Therapy, Ayurveda,
            and Kosha Counseling.
          </p>
          <p className="text-gray-700">
            This integrated approach recognizes that true healing requires
            addressing all aspects of our being—physical, energetic, mental,
            emotional, and spiritual. By working with these three complementary
            practices, we create lasting transformation from the inside out.
          </p>
        </div>

        {/* Benefits */}
        <div className="bg-emerald-50 rounded-2xl p-8 md:p-12">
          <h3 className="mb-8 text-emerald-700 text-center">
          ...
          <div className="mb-16">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="order-2 md:order-1">
                ...
                <p className="text-gray-700 mb-4">
                  Evidence-based therapeutic yoga practices designed to support
                  healing from chronic conditions, manage stress, process
                  trauma, and promote overall vitality.
                </p>
                <p className="text-gray-700 mb-6">
                  Our programs include personalized asana (postures), pranayama
                  (breathwork), meditation, and yogic lifestyle practices
          ...
          <div className="mb-16">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <p className="text-gray-700 mb-4">
                  Ancient wisdom for modern living. Ayurveda provides
                  personalized nutrition, herbal support, and lifestyle
                  recommendations based on your unique constitutional type
                  (dosha).
                </p>
                <p className="text-gray-700 mb-6">
                  Learn to align your daily rhythms with nature's cycles, choose
                  foods that nourish your specific needs, and create sustainable
                  practices that support long-term health and vitality.
                </p>
                <Link
                  to="/ayurveda"
                  className="inline-flex items-center gap-2 text-emerald-700 hover:text-emerald-800 transition-colors">
          ...
          <div>
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="order-2 md:order-1">
                ...
                <p className="text-gray-700 mb-4">
                  A profound exploration of the five layers (koshas) of your
                  being: physical, energetic, mental-emotional, wisdom, and
                  bliss. This counseling approach helps you understand and
                  address imbalances at their deepest level.
                </p>
                <p className="text-gray-700 mb-6">
                  Through guided inquiry and contemplative practices, we work
                  together to uncover limiting beliefs, heal old wounds, and
                  reconnect you with your authentic self and innate wisdom.
                </p>
                <Link
                  to="/kosha-counseling"
                  className="inline-flex items-center gap-2 text-emerald-700 hover:text-emerald-800 transition-colors">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="text-center">
            ...
            <p className="text-gray-600">
              We begin with a comprehensive assessment of your health history,
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">
              Receive a customized wellness plan integrating yoga therapy,
              Ayurvedic recommendations, and kosha-based counseling.
            </p>
          </div>
          <div className="text-center">
            <div className="w-16 h-16 bg-emerald-100 rounded-full flex items-center justify-center mx-auto mb-4">
            ...
            <p className="text-gray-600">
              Regular sessions to refine practices, address challenges, and
              celebrate progress on your healing journey.
            </p>
          </div>
        </div>
