/**
 * footer.js
 * Handles dynamic content fetching and carousel logic for the footer.
 */
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const publicationSlidesContainer = document.querySelector(".publication-slides");
    ...
    async function fetchBlogs() {
        try {
            ...
            const activeBlogs = data.filter(blog => !blog.suspended && blog.type === "blogs");
            // Sort: createdAt desc
    ...
    function renderBooks() {
        ...
        publicationSlidesContainer.innerHTML = booksData.map((book, index) => {
